...
import type AuthenticationState from 'src/models/users/authenticationState';
import { Manager, Socket } from 'socket.io-client';
import authManager from './authManager';
import { GroupState } from 'src/models/users/groupState';
...
export type BootParams<T extends BootCallback<State> = BootCallback<State>> =
...
export abstract class SocketManager implements SocketManagerContract {
  ...
  public get socket(): Socket {
    if (!this.$socket) this.$socket = this.socketWithAuth();
